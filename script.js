...
let animation = gsap.timeline({repeat:5, repeatDelay:7, delay:5})
...
function animateText() {
  ...
  layers.forEach(function(element, index){
    animation.fromTo(element, {opacity:0, scale:0}, {scale:1, opacity:1, repeat:1, yoyo:true, yoyoEase:true, repeatDelay:0.3, delay: 5})
  })
